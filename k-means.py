...
Original file is located at
    https://colab.research.google.com/drive/10ASI5LZkiEZ6KeIyjxQQLg7ZN_hC_Ew0
"""
...
data = '/content/gdrive/MyDrive/K_means/data.csv'
data = genfromtxt(data, delimiter=',')
centers = '/content/gdrive/MyDrive/K_means/centers.csv'
